...
switch ($searchBy) {
    case 'buyveg_name':
        ...
        break;
    case 'economiccenter':
        $sql = "SELECT * FROM buyvegetables WHERE economiccenter = '$keywords' OR economiccenter LIKE '%$keywords%'";
        break;
    case 'shopname':
        $sql = "SELECT * FROM buyvegetables WHERE shopname = '$keywords' OR shopname LIKE '%$keywords%'";
        break;
    case 'dateofveg':
        $sql = "SELECT * FROM buyvegetables WHERE dateofveg = '$keywords' OR dateofveg LIKE '%$keywords%'";
        break;
}
                ...
                <form class="product-margin" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <select class="form-control" name="searchBy">
                            <option value="buyveg_name" <?php echo ($searchBy == 'buyveg_name') ? 'selected' : ''; ?>>Vegetable Name</option>
