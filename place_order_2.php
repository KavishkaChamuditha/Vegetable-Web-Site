    ...
    while ($row = mysqli_fetch_assoc($result)) {
        foreach ($vegetable_id as $veg_id) {
            if ($row['veg_id'] == $veg_id) {
                checkout($row['veg_name'], $row['veg_price'], $row['shopname'], $row['mailaddress']);
...
<li class="list-group-item d-flex justify-content-between">
    ...
    <strong> Rs. <span id="total"><?php echo $total; ?></strong>
</li>
        </ul>
...
<script>
    ...
    function removeProduct(event) {
        ...
        listItem.remove();
        var price = parseInt(listItem.querySelector('.veg-price').textContent);
