<?php
  ...
  if($_SESSION['seller_id']==''){
    ...
    header("wholeseller_signin_1.php");
  }
    ...
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          ...
          <form  action="wholeseller_account_edit_2.php" method="post" enctype="multipart/form-data">
          <input type="hidden" name="seller_id" value="<?php echo $_SESSION ['seller_id']; ?>">
                ...
                <div class="form-outline form-white mb-4">
                    <input type="text" id="" name="sellername" name="sellername" class="form-control form-control-lg signinstyle text-dark" value="<?php echo $_SESSION['sellername']; ?>"/>
                    <label class="form-label" for="typeEmailX">Your Name</label>
                </div>

                <div class="form-outline form-white mb-4">
                  <input type="email" id="disabledTextInput" name="mailaddress" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['mailaddress']; ?>" readonly/>
                  <label class="form-label" for="typeEmailX">Email</label>
                </div>

                <div class="form-outline form-white mb-4">
                  <input type="password" id="disabledTextInput"  name="sellerpaswrd" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['sellerpaswrd']; ?>"/>
                  <label class="form-label" for="typePasswordX">Password</label>
                </div>
                
                <div class="form-outline form-white mb-4">
                  <input type="text" id="disabledTextInput" name="shopname" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['shopname']; ?>"/>
                  <label class="form-label" for="typeEmailX">Shop Name</label>
                </div>

                <div class="form-outline form-white mb-4">
                  <input type="text" id="disabledTextInput" name="economiccenter" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['economiccenter']; ?>"/>
                  <label class="form-label" for="typeEmailX">Economic Center</label>
                </div>

                <div class="form-outline form-white mb-4">
                  <input type="text" id="disabledTextInput" name="idnumber" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['idnumber']; ?>" readonly/>
