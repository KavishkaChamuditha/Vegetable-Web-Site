        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          ...
          <input type="hidden" name="farmer_id" value="<?php echo $row ['farmer_id']; ?>">
                ...
                <div class="form-outline form-white mb-4">
                    <input type="email" id="disabledTextInput" class="form-control form-control-lg signinstyle text-dark" value="<?php echo $_SESSION['farmername']; ?>" disabled />
                    <label class="form-label" for="typeEmailX">Your Name</label>
                </div>


                <div class="form-outline form-white mb-4">
                  <input type="email" id="disabledTextInput" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['farmailaddress']; ?>" disabled/>
                  <label class="form-label" for="typeEmailX">Email</label>
                </div>

                <div class="form-outline form-white mb-4">
                  <input type="password" id="disabledTextInput" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['farpassword']; ?>" disabled/>
                  <label class="form-label" for="typePasswordX">Password</label>
                </div>

                <div class="form-outline form-white mb-4">
                  <input type="email" id="disabledTextInput" class="form-control form-control-lg signinstyle" value="<?php echo $_SESSION['farmeridnumber']; ?>" disabled/>
                  <label class="form-label" for="typeEmailX">Email</label>
                </div>
