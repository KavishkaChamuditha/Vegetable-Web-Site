      ...
      if($_REQUEST['status']=="pass"){
        ...
        ?>
            <div class="alert alert-success alert-dismissible fade show product-alert" role="alert">
              ...
              <strong>Great </strong> Deleting new record is successfully done.
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
              <br />
              <a href="sellvegetables_delete_4.php" class="btn btn-success my-3">Delete Another Record</a>
            </div>
        <?php
      }
      else{
        ...
        ?>
            <div class="alert alert-danger alert-dismissible fade show product-alert" role="alert">
              ...
              <strong>Sorry</strong> Deleting new record failed. Pleas try again.
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
              <br />
              <a href="sellvegetables_delete_4.php" class="btn btn-danger my-3">Try again</a>
            </div>
        <?php
      }
